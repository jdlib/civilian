...
/**
 * An MethodArg which returns the value of a request parameter.
 */
public class ParameterValueArg extends ReqParamValueArg
{
	public ParameterValueArg(String name)
	{
		super(name);
	}

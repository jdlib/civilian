...
/**
 * TempContext is used as context instance by Application
 * until its actual context is set.
 * All its methods do nothing, return empty defaults or throw an UnsupportedOperationException.  
 */
public class TempContext extends Context
{
	public static final TempContext INSTANCE = new TempContext();
	
	
	private UnsupportedOperationException error()
	{
		return new UnsupportedOperationException("Context method may not be called before Application#init was called");
	}
